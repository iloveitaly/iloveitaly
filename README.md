...
- [railwayapp/nixpacks](https://github.com/railwayapp/nixpacks) ([v1.24.4](https://github.com/railwayapp/nixpacks/releases/tag/v1.24.4), 2 days ago) - App source &#43; Nix packages &#43; Docker = Image
- [langchain-ai/langchain](https://github.com/langchain-ai/langchain) ([langchain-ibm==0.1.9](https://github.com/langchain-ai/langchain/releases/tag/langchain-ibm%3D%3D0.1.9), 3 days ago) - 🦜🔗 Build context-aware reasoning applications
- [dolthub/dolt](https://github.com/dolthub/dolt) ([v1.41.3](https://github.com/dolthub/dolt/releases/tag/v1.41.3), 4 days ago) - Dolt – Git for Data
- [nodejs/node](https://github.com/nodejs/node) ([v22.4.0](https://github.com/nodejs/node/releases/tag/v22.4.0), 6 days ago) - Node.js JavaScript runtime ✨🐢🚀✨
