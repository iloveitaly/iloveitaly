...
- [noborus/ov](https://github.com/noborus/ov) ([v0.34.1](https://github.com/noborus/ov/releases/tag/v0.34.1), 1 day ago) - 🎑Feature-rich terminal-based text viewer.  It is a so-called terminal pager.
- [langchain-ai/langchain](https://github.com/langchain-ai/langchain) ([v0.1.17rc1](https://github.com/langchain-ai/langchain/releases/tag/v0.1.17rc1), 3 days ago) - 🦜🔗 Build context-aware reasoning applications
- [dolthub/dolt](https://github.com/dolthub/dolt) ([v1.35.11](https://github.com/dolthub/dolt/releases/tag/v1.35.11), 4 days ago) - Dolt – Git for Data
...
- [nodejs/node](https://github.com/nodejs/node) ([v22.0.0](https://github.com/nodejs/node/releases/tag/v22.0.0), 5 days ago) - Node.js JavaScript runtime ✨🐢🚀✨
- [iloveitaly/gmail-draft-creator](https://github.com/iloveitaly/gmail-draft-creator) ([v1.2.2](https://github.com/iloveitaly/gmail-draft-creator/releases/tag/v1.2.2), 5 days ago) - Simple tool to take a CSV and a template and create drafts in your Gmail. Can be used as a command line tool, or as a library.
